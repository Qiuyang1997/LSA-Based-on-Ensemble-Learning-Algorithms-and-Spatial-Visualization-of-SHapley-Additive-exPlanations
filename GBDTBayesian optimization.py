...
bayes_search = BayesSearchCV(gbdt, param_space, cv=10, scoring='roc_auc', n_jobs=-1, n_iter=50)
...
plt.grid(False)
plt.savefig(r'XXXX\GBDT.tif', dpi=500)
plt.show()

# 11. 保存交叉验证结果
results_df.to_excel(r'XXXX\GBDT调参.xlsx', index=False)
